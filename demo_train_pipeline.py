...
from deepcad.train_collection import training_class, check_forkserver_support
from deepcad.movie_display import display
from deepcad.utils import get_first_filename,download_demo

has_forkserver = check_forkserver_support()   # whether os.fork is available on this machine, for
# MultiProcessingDataLoaderIter will crash if using os.spawn rather os.forkserver to create new process.
...
num_workers = 0 if has_forkserver is False else 4
